...
import { supabase, supabaseConfig } from "./src/supabase";
...
function SettingsScreen({ c, settings, session, onUpdate, onReset }: { c: Colors; settings: Settings; session: Session | null; onUpdate: (settings: Settings) => void; onReset: () => void }) {
